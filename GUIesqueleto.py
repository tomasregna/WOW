...
class Ui_WOW(object):
    def setupUi(self, WOW):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 346, 561))
    ...
    def retranslateUi(self, WOW):
        ...
        self.sinosedea.setText(_translate("WOW", "Si no se desea usar dejar los campos vacíos. Usar formato IRAF."))
